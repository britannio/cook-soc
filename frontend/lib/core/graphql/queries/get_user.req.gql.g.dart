...
class _$GGetUserReq extends GGetUserReq {
  ...
  factory _$GGetUserReq([void Function(GGetUserReqBuilder)? updates]) =>
      (new GGetUserReqBuilder()..update(updates)).build();
  ...
  _$GGetUserReq._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, 'GGetUserReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
        operation, 'GGetUserReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, 'GGetUserReq', 'executeOnListen');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GGetUserReq')
          ..add('vars', vars)
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GGetUserReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
